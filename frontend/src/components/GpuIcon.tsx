export default function GpuIcon() {
  return (
    ...
    >
      ...
      <rect x="8" y="19" width="1" height="2" fill="white" opacity="0.7" />
      <rect x="10" y="19" width="1" height="2" fill="white" opacity="0.7" />
      <rect x="12" y="19" width="1" height="2" fill="white" opacity="0.7" />
      <rect x="14" y="19" width="1" height="2" fill="white" opacity="0.7" />
      <rect x="16" y="19" width="1" height="2" fill="white" opacity="0.7" />
    </svg>
  );
}
